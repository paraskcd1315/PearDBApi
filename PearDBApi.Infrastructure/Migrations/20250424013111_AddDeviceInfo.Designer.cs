...
namespace PearDBApi.Infrastructure.Migrations
{
    ...
    [Migration("20250424013111_AddDeviceInfo")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DeviceInfoDevice", b =>
                {
                    ...
                    b.HasKey("DeviceId", "DeviceInfoId");

                    b.HasIndex("DeviceInfoId");

                    b.ToTable("DeviceInfoDevice", (string)null);
                });
            ...
            modelBuilder.Entity("DeviceInfoDevice", b =>
                {
                    b.HasOne("PearDBApi.Domain.DeviceAggregate.Device", null)
                        .WithMany()
                        .HasForeignKey("DeviceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PearDBApi.Domain.DeviceInfoAggregate.DeviceInfo", null)
                        .WithMany()
